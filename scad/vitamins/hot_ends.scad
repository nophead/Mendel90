...
JHeadMk4 =            [jhead,   "HEJH16340: JHead MK4 hot end", 64, 5.1,         16,    50, "black", 12,            true, 4.64, 10.19 + 4, [0, 2.94, -5],  20];
JHeadMk5 =            [jhead,   "HEJH16340: JHead MK5 hot end", 54, 5.1,         16,    40, "black", 12,            true, 4.64, 9     + 4, [0, 2.38, -5],  20];

e3dv6_3mm =           [e3d,     "e3d V6 3mm direct",            62, 3.7,         16,    46, "lightgrey",  12,       true,    6,        15, [1, 5, -5], 15];
e3d_clone =           [e3d,     "e3d clone aliexpress",         66, 6.8,         16,    46, "lightgrey",  12,       true,    6,        15, [1, 5, -5], 15];
...
function hot_end_duct_height(type)        = type[12]; // Height on the nozzle side
